...
function get_discounted_priсe(price, num_goods, promo_code = null) {
  if (promo_code === 'ДАРИМ300') {
    if (price > 300) {
      price -= 300
    } else {
      console.log(0);
  ...
  if (promo_code === 'СКИДКА15' && price >= 20000) {
    price *= 0.85
  }
  console.log(price);
  return price;
...
get_discounted_priсe(25000, 11, 'ДАРИМ300');
get_discounted_priсe(300, 11, 'ДАРИМ300');
get_discounted_priсe(70000, 11, 'ДАРИМ300');
get_discounted_priсe(70000, 2, 'СКИДКА15');
get_discounted_priсe(300, 12);
get_discounted_priсe(7000, 2, 'СКИДКА15');